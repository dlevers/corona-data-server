class RatesController < ApplicationController
  def show
    ...
    # puts "RatesController.show: populationDataPathBase=" + populationDataPathBase
    ...
    #     dest = 'counties'
    #   else
    #     puts "RatesController.show: UNKNOWN population data filename=" + filename
    #   end
    ...
    #   end
    # end
    # puts "RatesController.show: Countries=" + @populationCountries.to_s
    # puts "RatesController.show: USStates=" + @populationUSStates.to_s
    # puts "RatesController.show: US-FLCounties=" + @populationUSFLCounties.to_s
